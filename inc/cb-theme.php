...
function widgets_init() {
    ...
    register_nav_menus(
        array(
            'primary_nav'  => __( 'Primary Nav', 'cb-turnpower2025' ),
            'footer_menu1' => __( 'Footer Nav 1', 'cb-turnpower2025' ),
        )
    );
...
function add_custom_menu_item($items, $args)
{
    if ($args->theme_location == 'primary_nav') {
        ...
        $new_item  = '<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" class="d-lg-none menu-item menu-item-type-post_type menu-item-object-page nav-item fs-500 pt-2 pb-4"><i class="fa-solid fa-envelope text-accent-400"></i> ' . do_shortcode( '[contact_email]' ) . '</li>';
        $new_item .= '<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" class="d-lg-none menu-item menu-item-type-post_type menu-item-object-page nav-item fs-500"><i class="fa-solid fa-phone text-accent-400"></i> ' . do_shortcode( '[contact_phone]' ) . '</li>';
